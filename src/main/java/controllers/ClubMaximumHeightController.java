...
public class ClubMaximumHeightController {

    @FXML
    private TextField clubNameField;

    @FXML
    private TableView<Player> clubMaximumHeightTable;
    ...
    public ClubMaximumHeightController() {
    ...
    public void onSearch(ActionEvent event) {
        ...
        // Get the players with the maximum height in the club
        List<Player> maxHeightPlayers = cricketPlayerDb.searchMaxHeightPlayer(clubName);

        // Convert to ObservableList for TableView
        ObservableList<Player> tableData = FXCollections.observableArrayList(maxHeightPlayers);
        clubMaximumHeightTable.setItems(tableData);
    }
