...
public class ClubMaximumAgeController {

    @FXML
    private TextField clubNameField;

    @FXML
    private TableView<Player> clubMaximumAgeTable;
    ...
    public ClubMaximumAgeController() {
    ...
    public void onSearch(ActionEvent event) {
        ...
        // Get the players with the maximum age in the club
        List<Player> maxAgePlayers = cricketPlayerDb.searchMaxAgePlayer(clubName);

        // Convert to ObservableList for TableView
        ObservableList<Player> tableData = FXCollections.observableArrayList(maxAgePlayers);
        clubMaximumAgeTable.setItems(tableData);
    }
