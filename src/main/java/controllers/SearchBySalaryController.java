...
public class SearchBySalaryController {
    ...
    public SearchBySalaryController() {
    ...
    public void onSearch(ActionEvent event) {
        ...
        // Ensure both fields have valid numeric values
        if (minSalaryText.isEmpty() || maxSalaryText.isEmpty()) {
            System.out.println("Please enter both minimum and maximum salary.");
            return;
        }
        ...
        try {
            ...
            List<Player> results = cricketPlayerDb.searchBySalaryRange(minSalary, maxSalary);

            // Update the table with search results
            playersList.setAll(results); // This updates the TableView directly

        } catch (NumberFormatException e) {
            System.out.println("Please enter valid numeric values for salary.");
        }
    }
}
